// BBS シードスクリプト2 — node seed_bbs2.mjs で実行
...
const posts = [
  ...
  },
  {
    author: '電子ドラム派',
    flair: '雑談',
    title: 'マンションで生ドラム練習できてる人いる？',
    body: '防音室作るか電子ドラムにするか悩みすぎてる。防音室DIYしてる人いたらコスト感教えてほしい。電子ドラムも叩き心地が気になる',
    gear_tag: null,
  },
  ...
  // ── 雑談 ──────────────────────────────────────
  {
    author: '機材貧乏',
    flair: '雑談',
    title: '機材代が生活費より多い月があるんだが',
    body: '先月エフェクター3個、シールド2本、弦5セット買ったら食費超えた。みんな機材費用どうやって管理してる？やめられん',
    gear_tag: null,
  },
  {
    author: 'ネット購入派',
    flair: '雑談',
    title: 'ギター試奏せずにネットで買って後悔した話',
    body: 'YouTubeのレビュー動画だけ見てSquier Classic Vibes買ったら思ったより塗装ムラあって凹んだ。みんな試奏派？ネット購入派？',
    gear_tag: null,
  },
  {
    author: '楽器屋バイト',
    flair: '雑談',
    title: '楽器屋でバイトして気づいた機材の豆知識',
    body: '島村楽器でバイトして1年。在庫管理してたら意外な事実が判明。展示品って意外と売れてて型落ちモデルが超コスパいいってこと。展示落ちが一番お得かも',
    gear_tag: null,
  },
  {
    author: 'ライブハウス常連',
    flair: '雑談',
    title: 'ライブハウスのバックラインって実際どこまで信用できる？',
    body: '地方の小箱でMarshallのアンプ使ったら音がボソボソで全然ダメだった。自前アンプ持ち込み派？ライブハウスのバックライン信用してる？',
    gear_tag: null,
  },
  {
    author: 'ギタリスト兼Vo',
    flair: '雑談',
    title: 'ギター弾きながら歌う練習法教えて',
    body: '弾き語りの練習して半年、いまだに両立できない。歌うとギターが止まる、ギター弾くと歌詞飛ぶ。コツとか練習法あれば教えてください',
    gear_tag: null,
  },
  {
    author: '機材売買マン',
    flair: '雑談',
    title: 'メルカリで楽器売るときのコツ教えて',
    body: '使わなくなったギター3本売りたい。写真の撮り方とか説明文の書き方とか、査定価格より高く売るコツある？ヤフオクとどっちがいい？',
    gear_tag: null,
  },
];
  ...
  for (const [title, comments] of Object.entries(commentsByTitle)) {
    ...
    for (const comment of comments) {
      ...
      if (error) {
        ...
        console.log(`  └ [${comment.author}] ${comment.body.slice(0, 40)}...`);
      }
    }
  }
